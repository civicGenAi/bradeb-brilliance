...
export default function AboutPage() {
  return (
    <PageShell>
      ...
      <section
        className="relative min-h-[92vh] flex items-end pt-24 pb-12 overflow-hidden"
        style={{
          background: "radial-gradient(circle at 20% 0%, #1d3c6b 0%, #07396c 45%, #0a1628 100%)",
        }}
      >
        {/* Blueprint grid */}
        <svg
        ...
        >
          {[60, 120, 80, 160, 100, 140, 90, 180, 110, 150, 70, 130, 95, 165, 85, 145].map(
            (h, i) => (
        ...
        {/* Gold compass orbit */}
        <svg
          className="absolute -right-32 top-12 w-[420px] h-[420px] opacity-30 animate-spin-slow hidden md:block"
          viewBox="0 0 200 200"
        >
        ...
        <div className="relative mx-auto max-w-7xl w-full px-6 lg:px-10 grid lg:grid-cols-12 gap-8 items-end">
          <div className="lg:col-span-8">
            ...
            <h1 className="font-heading font-black text-white text-[3.5rem] sm:text-7xl lg:text-[8.5rem] leading-[0.85] tracking-tight">
              ...
              <span
                className="block animate-clip-up text-stroke-white"
                style={{ animationDelay: "0.2s" }}
              >
                on
              </span>
              <span
                className="block animate-clip-up text-gradient-gold"
          ...
          <div className="lg:col-span-4 space-y-3">
            {[
              ...
              <div
                key={c.k}
                className="group flex items-center gap-5 bg-white/[0.04] border border-white/10 backdrop-blur rounded-xl p-4 hover:bg-white/[0.08] hover:border-gold/40 transition-all animate-fade-up"
                style={{ animationDelay: `${0.6 + i * 0.12}s` }}
              >
                <span className="font-heading font-black text-gold text-4xl w-12 text-center group-hover:scale-110 transition-transform">
                  {c.k}
                </span>
      ...
      <section className="py-20 md:py-28 bg-white relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10 grid lg:grid-cols-[5fr_7fr] gap-12 lg:gap-20 items-start">
          <Reveal variant="left">
            ...
            <h2 className="font-heading font-extrabold text-navy text-3xl md:text-5xl mb-8 leading-[1.05]">
              A <span className="text-teal">trusted</span> Tanzanian builder.
            </h2>
            <div className="space-y-5 text-[#4a5568] leading-relaxed text-[15px]">
              <p>
                Bradeb Investment Limited is a wholly Tanzanian-owned company specialising in
                building construction, civil engineering, and professional fumigation services.
              </p>
              <p>
                ...
                {[
                  {
                    year: "2020",
                    title: "Incorporated",
                    body: "Founded under Companies Act 2002.",
                    color: "#1d3c6b",
                  },
                  {
                    year: "2022",
                    title: "VAT Registered",
                    body: "TRA registration; first major projects.",
                    color: "#17767c",
                  },
                  {
                    year: "2024",
                    title: "CRB Class V",
                    body: "Building & Civil certification awarded.",
                    color: "#2e9ca3",
                  },
                ].map((m, i) => (
                  <Reveal
                  ...
                  >
                    <span
                      className="block mx-auto h-4 w-4 rounded-full ring-4 ring-white relative z-10 group-hover:scale-150 transition-transform"
                      style={{ background: m.color, boxShadow: `0 0 0 6px ${m.color}22` }}
                    />
                    <div className="mt-6 p-5 rounded-2xl border border-black/5 bg-white hover-lift-glow text-center md:text-left">
                      ...
                      <p className="text-[#4a5568] text-xs md:text-sm mt-2 leading-relaxed">
                        {m.body}
                      </p>
                    </div>
                  </Reveal>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
            ...
            <p className="text-[#4a5568] max-w-md text-sm">
              Three pillars that shape every brick we lay and every site we secure.
            </p>
          </div>
            ...
            {[
              {
                t: "Mission",
                n: "01",
                b: "Deliver world-class construction and fumigation services that exceed client expectations.",
                bg: "#1d3c6b",
                span: "md:col-span-5 md:row-span-2 min-h-[380px]",
              },
              {
                t: "Vision",
                n: "02",
                b: "To be a top-rated regional market leader in construction and pest control.",
                bg: "#17767c",
              ...
              <Reveal
                ...
                delay={i * 140}
                key={c.t}
                className={`group relative overflow-hidden hover-lift-glow rounded-3xl p-8 md:p-10 flex flex-col justify-between ${c.span}`}
              ...
              >
                ...
                <div className="relative flex items-start justify-between">
                  <span className="font-heading font-black text-white/15 text-7xl leading-none">
                    {c.n}
                  </span>
                  <span className="px-3 py-1 rounded-full text-[10px] uppercase tracking-[0.2em] font-bold border border-white/20 text-white/70">
                    Pillar
                  </span>
                </div>
                <div className="relative">
                  <h3
                    className={`font-heading font-black text-3xl md:text-4xl mb-3 ${c.accent ? "text-gold" : "text-white"}`}
                  >
                    {c.t}
                  </h3>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10 grid lg:grid-cols-[5fr_7fr] gap-14">
          <div className="lg:sticky lg:top-32 self-start">
            ...
            <h2 className="font-heading font-extrabold text-white text-4xl md:text-5xl mb-6 overflow-hidden">
              <SplitText text="Our Six Objectives" />
            </h2>
            <p className="text-white/70 leading-relaxed">
              A disciplined framework that turns plans into permanent structures, on time and on
              budget.
            </p>
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {[
              ...
              <Reveal
                ...
                key={o}
                variant="scale"
                className="group relative p-5 rounded-xl bg-white/[0.04] border border-white/10 hover:bg-white/[0.1] hover:border-gold/40 transition-all overflow-hidden"
              >
                <span className="absolute right-0 top-0 font-heading font-black text-white/5 text-7xl leading-none group-hover:text-gold/20 transition-colors">
                  {String(i + 1).padStart(2, "0")}
                </span>
                <span className="font-heading font-black text-gold text-xs tracking-[0.2em]">
      ...
      <section
        className="py-20 md:py-28 relative overflow-hidden"
        style={{ background: "linear-gradient(135deg, #17767c, #17767c)" }}
      >
        <svg
        ...
        >
          <defs>
            <pattern id="hex" width="50" height="44" patternUnits="userSpaceOnUse">
              <polygon points="25,2 47,15 47,40 25,42 3,40 3,15" fill="none" stroke="#fff" />
            </pattern>
          </defs>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10 relative">
          <div className="text-center mb-14">
            ...
            <h2 className="font-heading font-extrabold text-white text-4xl md:text-5xl">
              Environment · Health · Safety
            </h2>
            <p className="text-white/70 max-w-2xl mx-auto mt-4">
              Three commitments enforced on every Bradeb site, every day.
            </p>
          </div>
            ...
            {[
              {
                Icon: Leaf,
                t: "Environment",
                b: "Sustainable methods and responsible material sourcing on every site.",
                num: "01",
              },
              {
                Icon: HeartPulse,
                t: "Health",
                b: "Worker wellbeing prioritised through training, PPE, and supervision.",
                num: "02",
              },
              {
                Icon: ShieldCheck,
                t: "Safety",
                b: "Zero-harm culture with documented procedures and on-site safety officers.",
                num: "03",
              },
            ].map(({ Icon, t, b, num }, i) => (
              <Reveal
                ...
                variant="scale"
                key={t}
                className="group relative bg-white/10 backdrop-blur rounded-2xl p-8 hover-lift-glow border-t-2 border-gold md:even:translate-y-8 transition-all"
              >
