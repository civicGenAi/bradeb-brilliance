...
const certs = [
  ...
  {
    t: "CRB Building Contractor Class V",
    body: "Contractors Reg. Board",
    num: "B5/1722/01/2024",
    date: "Jan 6, 2024",
    color: "#17767c",
  },
  {
    t: "CRB Civil Works Contractor Class V",
    body: "CRB Tanzania",
    num: "C5/1579/01/2024",
    date: "Jan 3, 2024",
    color: "#17767c",
  ...
  {
    t: "TIN Registration",
    body: "Tanzania Revenue Authority",
    num: "TIN 142-322-722",
    date: "Aug 7, 2020",
    color: "#1d3c6b",
  },
  ...
  {
    t: "Zanzibar Certificate of Incorporation",
    body: "Rev. Govt of Zanzibar",
    num: "Z0000152767",
    date: "Jun 1, 2022",
    color: "#17767c",
  },
  ...
  return (
    <PageShell>
      ...
      >
        ...
        <svg
          className="absolute -right-20 top-1/2 -translate-y-1/2 w-[500px] h-[500px] opacity-20"
          viewBox="0 0 200 200"
        >
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-10 py-20">
          ...
          <Link
            to="/contact"
            className="btn-shine mt-10 inline-flex items-center gap-2 rounded-full bg-gold px-7 py-4 text-near-black font-bold uppercase tracking-[0.15em] text-sm hover:scale-105 transition"
          >
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div>
              <p className="eyebrow text-teal mb-3 flex items-center gap-2">
                <span className="h-px w-8 bg-gold" /> Core Capabilities
              </p>
              <h2 className="font-heading font-extrabold text-navy text-3xl md:text-5xl leading-tight">
                Construction <span className="text-teal">Services</span>
              </h2>
            </div>
            ...
            {[
              {
                ...
                b: "Residential · commercial · industrial structures built to spec.",
              ...
              },
              {
                Icon: HardHat,
                t: "Civil Works",
                b: "Structural, foundations, concrete.",
                span: "md:col-span-3",
              },
              {
                Icon: Wrench,
                t: "Mechanical Contracting",
                b: "HVAC, plumbing, systems installation.",
                span: "md:col-span-3",
              },
              {
                Icon: Zap,
                t: "Electrical Engineering",
                b: "LV/HV installations and certified wiring.",
                span: "md:col-span-6",
              },
              ...
              <Reveal
                ...
                delay={i * 110}
                key={t}
                className={`group relative overflow-hidden hover-lift-glow border border-black/5 rounded-2xl transition-all hover:border-teal/30 flex flex-col justify-between ${span} ${big ? "min-h-[320px]" : "min-h-[180px] bg-gradient-to-br from-white to-[#f8f9fa] p-7"}`}
              >
                {big ? (
                  <>
                    <Media
                    ...
                    <div className="relative z-10 mt-auto p-7">
                      <div className="h-14 w-14 rounded-2xl bg-teal flex items-center justify-center mb-5 shadow-lg">
                        <Icon className="text-white" size={28} />
                      </div>
                      <h3 className="font-heading font-bold text-white text-2xl md:text-3xl mb-2">
                        {t}
                      </h3>
                      <p className="text-white/80 text-sm leading-relaxed max-w-md">{b}</p>
                    </div>
                  </>
                ) : (
                  <>
                    ...
                    <div className="relative flex items-start justify-between">
                      <div className="h-12 w-12 rounded-2xl bg-teal/10 flex items-center justify-center group-hover:bg-teal group-hover:rotate-[-6deg] transition-all">
                        <Icon
                          className="text-teal group-hover:text-white transition-colors"
                          size={22}
                        />
                      </div>
                      <span className="font-heading font-black text-navy/10 text-2xl">
                        0{i + 1}
                      </span>
                    </div>
                    <div className="relative mt-6">
                      <h3 className="font-heading font-bold text-navy text-lg mb-2 group-hover:text-teal transition-colors">
                        {t}
                      </h3>
          ...
          <div className="mt-14 rounded-2xl border border-black/5 bg-[#f8f9fa] p-6 md:p-8 flex flex-col md:flex-row md:items-center gap-5">
            <p className="eyebrow text-teal shrink-0 md:border-r md:border-black/10 md:pr-6">
              General Supply To
            </p>
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <span
                  key={s}
                  className="px-4 py-2 rounded-full bg-white border border-navy/15 text-navy text-xs font-semibold hover:bg-navy hover:text-white hover:border-navy transition-all cursor-default"
                >
                  {s}
                </span>
              ))}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10 relative">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div>
              ...
              <h2 className="font-heading font-extrabold text-navy text-3xl md:text-5xl">
                Pest-Free. <span className="text-teal">Guaranteed.</span>
              </h2>
            </div>
            <div className="flex items-center gap-3 px-5 py-3 rounded-full bg-soft-green/15 border border-soft-green/30 self-start">
              ...
              <span className="text-soft-green text-sm font-semibold">
                Certified chemicals · Insured operations
              </span>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-4 mb-10">
            {[
              ...
              <Reveal
                ...
                variant="scale"
                key={t}
                className="group relative bg-white rounded-2xl p-6 border border-black/5 hover-lift-glow lg:[&:nth-child(even)]:translate-y-6 transition-all"
              >
                ...
                <h3 className="font-heading font-bold text-navy text-base mb-1.5 group-hover:text-teal transition-colors">
                  {t}
                </h3>
          ...
          >
            <div className="p-8 md:p-12">
              ...
              <h3 className="font-heading font-extrabold text-white text-2xl md:text-3xl mb-6 leading-tight">
                Built on protocols, not promises.
              </h3>
              <p className="text-white/70 text-sm">
                Every treatment plan begins with a site survey and ends with documented follow-ups.
              </p>
            </div>
            <ul className="bg-white/5 backdrop-blur p-8 md:p-12 divide-y divide-white/10">
              {[
                ...
                <li key={b} className="flex items-start gap-4 py-3 first:pt-0 last:pb-0">
                  <span className="font-heading font-black text-gold text-sm w-6 shrink-0">
                    0{i + 1}
                  </span>
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10 relative">
          <div className="text-center mb-16">
            ...
            <h2 className="font-heading font-extrabold text-white text-4xl md:text-5xl overflow-hidden inline-block">
              <SplitText text="How We Work" />
            </h2>
            <p className="text-white/60 mt-4 max-w-xl mx-auto text-sm">
              Five disciplined steps from first conversation to final handover.
            </p>
          </div>
      ...
      <section className="py-24 bg-white relative overflow-hidden" id="certifications">
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10 relative">
          <Reveal className="mb-14 text-center">
            <p className="eyebrow text-teal mb-3 justify-center flex items-center gap-2">
              <span className="w-8 h-[2px] bg-gold"></span> Legal & Compliance
            </p>
            ...
            <p className="mt-4 text-[#4a5568] max-w-2xl mx-auto">
              Operating fully under Tanzanian law with all necessary board registrations and
              municipal licenses.
            </p>
          </Reveal>
          ...
          <div className="flex overflow-x-auto snap-x snap-mandatory gap-6 pb-12 pt-4 px-4 -mx-4 hide-scrollbar">
            {certs.map((c, i) => (
              <Reveal
                ...
                delay={i * 80}
                key={c.t}
                className="group hover-lift-glow tilt-3d bg-white rounded-xl overflow-hidden border border-navy/5 shadow-xl shadow-navy/5 transition-all hover:border-b-[4px] hover:border-gold min-w-[280px] md:min-w-[320px] snap-center flex flex-col justify-between"
              >
                <div
                ...
                <div className="p-6 h-[200px] flex flex-col justify-between">
                  <div>
                    <h3 className="font-heading font-bold text-navy text-sm leading-snug mb-2 group-hover:text-teal transition-colors">
                      {c.t}
                    </h3>
                  ...
                  <div className="flex items-center justify-between border-t border-navy/5 pt-3">
                    ...
                    <span className="px-2 py-1 rounded-md bg-soft-green/15 text-soft-green text-[10px] font-bold uppercase tracking-wider">
                      Valid
                    </span>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-6">
            {[
              {
                t: "Building Contractor Class V Licence",
                body: "Kinondoni Municipal Council",
                valid: "Valid to Feb 7, 2026",
              },
              {
                t: "Civil Contractor Class V Licence",
                body: "Kinondoni Municipal Council",
                valid: "Valid to Apr 4, 2026",
              },
            ].map((l) => (
              <div
                key={l.t}
                className="rounded-xl bg-[#f8f9fa] p-8 border-l-4 border-teal flex flex-col justify-between items-start"
              >
                <div>
                  <h3 className="font-heading font-bold text-navy text-xl mb-2">{l.t}</h3>
                  <p className="text-[#4a5568] text-sm mb-4">{l.body}</p>
                </div>
                <span className="px-3 py-1.5 rounded-md bg-gold/15 text-[#0e5a5f] text-[11px] font-bold uppercase">
                  {l.valid}
                </span>
              </div>
            ))}
      ...
      <section className="py-24 relative overflow-hidden" style={{ backgroundColor: "#1d3c6b" }}>
        ...
        <div className="mx-auto max-w-4xl px-6 text-center relative z-10">
          ...
          <p className="text-white text-xl md:text-2xl leading-relaxed font-medium">
            All operations strictly comply with the Companies Act 2002, Contractors Registration Act
            No. 17 of 1997, and Tanzania Revenue Authority requirements.
          </p>
          <div className="h-px w-24 bg-gold mx-auto my-10" />
          <a
            href={profilePdf}
            download="Bradeb_Company_Profile.pdf"
            className="btn-shine inline-flex items-center gap-2 rounded-full bg-teal px-8 py-4 text-white font-bold uppercase text-sm tracking-[0.15em] hover:scale-105 transition-transform shadow-[0_0_20px_rgba(46,156,163,0.3)]"
          >
